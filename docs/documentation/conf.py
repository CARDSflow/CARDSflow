...
project = u'CARDSFlow'
copyright = u'2018, CARDSFlow'
author = u'Simon Trendel'
...
htmlhelp_basename = 'CARDSFlowdoc'
...
man_pages = [
    (master_doc, 'CARDSFlow', u'CARDSFlow',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'CARDSFlow', u'CARDSFlow',
     author, 'CARDSFlow', 'libraries for exporting, simulating and controlling cable robots',
     'Miscellaneous'),
]
